...
describe("Test Ruler Calculations", () => {
  ...
  describe("Test Ruler helper calculations", () => {
    ...
    it("should have number of ticks value_30 = 10 >6<20 = true", () => {
      expect(ruler.isValidPartition(30, 300)).to.be.true;
    });
    it("should have number of ticks value_100 = 3 >6<20 = false", () => {
      expect(ruler.isValidPartition(100, 300)).to.be.false;
    });
    it("should have number of ticks value_6 = 50 >6<20 = false", () => {
      expect(ruler.isValidPartition(6, 300)).to.be.false;
    });
    it("should have returned array of valid tickSteps from 300 = [ 15, 20, 25, 30, 50 ]", () => {
    ...
    it("should have userfriendly tickStep out of array of valid = 50", () => {
      const validArr: number[] = ruler.getValidTickStepsArr(300);
      expect(ruler.getFavorableTickStep(validArr, 300)).to.equal(50);
    });
    it("should have a type of returned object { num: number; grade: number } =true", () => {
    ...
    it("should have an object of num (300)= num with no zeros =3,grade = zeros removed=2", () => {
